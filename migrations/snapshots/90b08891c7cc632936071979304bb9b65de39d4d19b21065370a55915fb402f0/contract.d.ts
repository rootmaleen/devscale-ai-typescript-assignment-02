...
export type StorageHash =
  StorageHashBase<'90b08891c7cc632936071979304bb9b65de39d4d19b21065370a55915fb402f0'>;
export type ExecutionHash =
  ExecutionHashBase<'33dbf2d716a0d2719860c5aea8d4ac76b9b1421b86cc4321568c037fbecc60d4'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Job: {
      ...
      readonly diet: CodecTypes['pg/text@1']['output'];
    ...
    readonly JobResult: {
      ...
      readonly ingredients: CodecTypes['pg/text@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    readonly Job: {
      ...
      readonly diet: CodecTypes['pg/text@1']['input'];
    ...
    readonly JobResult: {
      ...
      readonly ingredients: CodecTypes['pg/text@1']['input'];
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly outboxMessage: {
              ...
              indexes: readonly [
                {
                  readonly name: 'outboxMessage_jobId_idx_623c8f77';
                  readonly prefix: 'outboxMessage_jobId_idx';
                  readonly columns: readonly ['jobId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'outboxMessage';
                    readonly columns: readonly ['jobId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
          ...
          readonly Job: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly diet: { readonly column: 'diet' };
